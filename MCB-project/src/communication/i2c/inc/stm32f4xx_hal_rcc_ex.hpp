...
typedef struct
{
  ...
  std::uint32_t PLLP;       /*!< PLLP: Division factor for main system clock (SYSCLK).
                            This parameter must be a value of @ref RCC_PLLP_Clock_Divider             */

  std::uint32_t PLLQ;       /*!< PLLQ: Division factor for OTG FS, SDIO and RNG clocks.
  ...
  std::uint32_t PLLR;       /*!< PLLR: PLL division factor for I2S, SAI, SYSTEM, SPDIFRX clocks.
...
typedef struct
{
  std::uint32_t PLLI2SM;    /*!< Specifies division factor for PLL VCO input clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 63       */

  std::uint32_t PLLI2SN;    /*!< Specifies the multiplication factor for PLLI2S VCO output clock.
                            This parameter must be a number between Min_Data = 50 and Max_Data = 432    */

  std::uint32_t PLLI2SP;    /*!< Specifies division factor for SPDIFRX Clock.
                            This parameter must be a value of @ref RCCEx_PLLI2SP_Clock_Divider           */

  std::uint32_t PLLI2SQ;    /*!< Specifies the division factor for SAI clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 15.
                            This parameter will be used only when PLLI2S is selected as Clock Source SAI */

  std::uint32_t PLLI2SR;    /*!< Specifies the division factor for I2S clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 7.
...
typedef struct
{
  std::uint32_t PLLSAIM;    /*!< Specifies division factor for PLL VCO input clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 63       */

  std::uint32_t PLLSAIN;    /*!< Specifies the multiplication factor for PLLI2S VCO output clock.
                            This parameter must be a number between Min_Data = 50 and Max_Data = 432    */

  std::uint32_t PLLSAIP;    /*!< Specifies division factor for OTG FS, SDIO and RNG clocks.
                            This parameter must be a value of @ref RCCEx_PLLSAIP_Clock_Divider           */

  std::uint32_t PLLSAIQ;    /*!< Specifies the division factor for SAI clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 15.
...
typedef struct
{
  std::uint32_t PeriphClockSelection; /*!< The Extended Clock to be configured.
  ...
  std::uint32_t PLLI2SDivQ;           /*!< Specifies the PLLI2S division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLLI2S is selected as Clock Source SAI */

  std::uint32_t PLLSAIDivQ;           /*!< Specifies the PLLI2S division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLLSAI is selected as Clock Source SAI */

  std::uint32_t Sai1ClockSelection;    /*!< Specifies SAI1 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_SAI1_Clock_Source */

  std::uint32_t Sai2ClockSelection;    /*!< Specifies SAI2 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_SAI2_Clock_Source */

  std::uint32_t I2sApb1ClockSelection;    /*!< Specifies I2S APB1 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_I2SAPB1_Clock_Source */

  std::uint32_t I2sApb2ClockSelection;    /*!< Specifies I2S APB2 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_I2SAPB2_Clock_Source */

  std::uint32_t RTCClockSelection;      /*!< Specifies RTC Clock Source Selection.
                                      This parameter can be a value of @ref RCC_RTC_Clock_Source */

  std::uint32_t SdioClockSelection;    /*!< Specifies SDIO Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_SDIO_Clock_Source */

  std::uint32_t CecClockSelection;      /*!< Specifies CEC Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_CEC_Clock_Source */

  std::uint32_t Fmpi2c1ClockSelection;  /*!< Specifies FMPI2C1 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_FMPI2C1_Clock_Source */

  std::uint32_t SpdifClockSelection;    /*!< Specifies SPDIFRX Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_SPDIFRX_Clock_Source */

  std::uint32_t Clk48ClockSelection;     /*!< Specifies CLK48 Clock Selection this clock used OTG FS, SDIO and RNG clocks.
...
typedef struct
{
  ...
  std::uint32_t I2SClockSelection;      /*!< Specifies RTC Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_I2S_APB_Clock_Source */

  std::uint32_t RTCClockSelection;      /*!< Specifies RTC Clock Source Selection.
                                      This parameter can be a value of @ref RCC_RTC_Clock_Source */

  std::uint32_t Lptim1ClockSelection;   /*!< Specifies LPTIM1 Clock Source Selection.
...
typedef struct
{
  ...
  std::uint32_t PLLDivR;              /*!< Specifies the PLL division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLL is selected as Clock Source SAI */

  std::uint32_t PLLI2SDivR;           /*!< Specifies the PLLI2S division factor for SAI1 clock.
                                      This parameter must be a number between Min_Data = 1 and Max_Data = 32
                                      This parameter will be used only when PLLI2S is selected as Clock Source SAI */
  ...
  std::uint32_t Dfsdm1ClockSelection;    /*!< Specifies DFSDM1 Clock Selection.
                                      This parameter can be a value of @ref RCCEx_DFSDM1_Kernel_Clock_Source */

  std::uint32_t Dfsdm1AudioClockSelection;/*!< Specifies DFSDM1 Audio Clock Selection.
                                      This parameter can be a value of @ref RCCEx_DFSDM1_Audio_Clock_Source */

#if defined(STM32F413xx) || defined(STM32F423xx)
  std::uint32_t Dfsdm2ClockSelection;    /*!< Specifies DFSDM2 Clock Selection.
                                      This parameter can be a value of @ref RCCEx_DFSDM2_Kernel_Clock_Source */

  std::uint32_t Dfsdm2AudioClockSelection;/*!< Specifies DFSDM2 Audio Clock Selection.
                                      This parameter can be a value of @ref RCCEx_DFSDM2_Audio_Clock_Source */

  std::uint32_t Lptim1ClockSelection;   /*!< Specifies LPTIM1 Clock Source Selection.
                                      This parameter can be a value of @ref RCCEx_LPTIM1_Clock_Source */

  std::uint32_t SaiAClockSelection;     /*!< Specifies SAI1_A Clock Prescalers Selection
                                        This parameter can be a value of @ref RCCEx_SAI1_BlockA_Clock_Source */

  std::uint32_t SaiBClockSelection;     /*!< Specifies SAI1_B Clock Prescalers Selection
                                        This parameter can be a value of @ref RCCEx_SAI1_BlockB_Clock_Source */
#endif /* STM32F413xx || STM32F423xx */

  std::uint32_t PLLI2SSelection;      /*!< Specifies PLL I2S Clock Source Selection.
...
typedef struct
{
  ...
  std::uint32_t PLLI2SQ;    /*!< Specifies the division factor for SAI1 clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 15.
                            This parameter will be used only when PLLI2S is selected as Clock Source SAI */
} RCC_PLLI2SInitTypeDef;
...
typedef struct
{
  ...
  std::uint32_t PLLSAIP;    /*!< Specifies division factor for OTG FS and SDIO clocks.
                            This parameter is only available in STM32F469xx/STM32F479xx devices.
                            This parameter must be a value of @ref RCCEx_PLLSAIP_Clock_Divider  */
#endif /* STM32F469xx || STM32F479xx */

  std::uint32_t PLLSAIQ;    /*!< Specifies the division factor for SAI1 clock.
                            This parameter must be a number between Min_Data = 2 and Max_Data = 15.
                            This parameter will be used only when PLLSAI is selected as Clock Source SAI or LTDC */

  std::uint32_t PLLSAIR;    /*!< specifies the division factor for LTDC clock
                            This parameter must be a number between Min_Data = 2 and Max_Data = 7.
...
typedef struct
{
  ...
  std::uint32_t PLLSAIDivR;           /*!< Specifies the PLLSAI division factor for LTDC clock.
                                      This parameter must be one value of @ref RCCEx_PLLSAI_DIVR */

  std::uint32_t RTCClockSelection;      /*!< Specifies RTC Clock Prescalers Selection.
                                      This parameter can be a value of @ref RCC_RTC_Clock_Source */
...
typedef struct
{
  ...
  std::uint32_t PLLI2SM;    /*!< PLLM: Division factor for PLLI2S VCO input clock.
...
#define RCC_CLK48CLKSOURCE_PLLSAIP           ((std::uint32_t)RCC_DCKCFGR_CK48MSEL)
/**
  * @}
  */
...
#define RCC_SDIOCLKSOURCE_SYSCLK            ((std::uint32_t)RCC_DCKCFGR_SDIOSEL)
/**
  * @}
  */
...
#define RCC_DSICLKSOURCE_PLLR               ((std::uint32_t)RCC_DCKCFGR_DSISEL)
/**
  * @}
  */
#endif /* STM32F469xx || STM32F479xx */
...
#define RCC_SAI1CLKSOURCE_PLLI2S             ((std::uint32_t)RCC_DCKCFGR_SAI1SRC_0)
#define RCC_SAI1CLKSOURCE_PLLR               ((std::uint32_t)RCC_DCKCFGR_SAI1SRC_1)
#define RCC_SAI1CLKSOURCE_EXT                ((std::uint32_t)RCC_DCKCFGR_SAI1SRC)
/**
  * @}
  */
...
#define RCC_SAI2CLKSOURCE_PLLI2S             ((std::uint32_t)RCC_DCKCFGR_SAI2SRC_0)
#define RCC_SAI2CLKSOURCE_PLLR               ((std::uint32_t)RCC_DCKCFGR_SAI2SRC_1)
#define RCC_SAI2CLKSOURCE_PLLSRC             ((std::uint32_t)RCC_DCKCFGR_SAI2SRC)
/**
  * @}
  */
...
#define RCC_I2SAPB1CLKSOURCE_EXT             ((std::uint32_t)RCC_DCKCFGR_I2S1SRC_0)
#define RCC_I2SAPB1CLKSOURCE_PLLR            ((std::uint32_t)RCC_DCKCFGR_I2S1SRC_1)
#define RCC_I2SAPB1CLKSOURCE_PLLSRC          ((std::uint32_t)RCC_DCKCFGR_I2S1SRC)
/**
  * @}
  */
...
#define RCC_I2SAPB2CLKSOURCE_EXT             ((std::uint32_t)RCC_DCKCFGR_I2S2SRC_0)
#define RCC_I2SAPB2CLKSOURCE_PLLR            ((std::uint32_t)RCC_DCKCFGR_I2S2SRC_1)
#define RCC_I2SAPB2CLKSOURCE_PLLSRC          ((std::uint32_t)RCC_DCKCFGR_I2S2SRC)
/**
  * @}
  */
...
#define RCC_FMPI2C1CLKSOURCE_SYSCLK           ((std::uint32_t)RCC_DCKCFGR2_FMPI2C1SEL_0)
#define RCC_FMPI2C1CLKSOURCE_HSI              ((std::uint32_t)RCC_DCKCFGR2_FMPI2C1SEL_1)
/**
  * @}
  */
...
#define RCC_CECCLKSOURCE_LSE                ((std::uint32_t)RCC_DCKCFGR2_CECSEL)
/**
  * @}
  */
...
/** @defgroup RCCEx_CLK48_Clock_Source  RCC CLK48 Clock Source
  ...
  */
#define RCC_CLK48CLKSOURCE_PLLQ              0x00000000U
#define RCC_CLK48CLKSOURCE_PLLSAIP           ((std::uint32_t)RCC_DCKCFGR2_CK48MSEL)
/**
  * @}
  */
...
/** @defgroup RCCEx_SDIO_Clock_Source  RCC SDIO Clock Source
  ...
  */
#define RCC_SDIOCLKSOURCE_CLK48             0x00000000U
#define RCC_SDIOCLKSOURCE_SYSCLK            ((std::uint32_t)RCC_DCKCFGR2_SDIOSEL)
/**
  * @}
  */
...
#define RCC_SPDIFRXCLKSOURCE_PLLI2SP        ((std::uint32_t)RCC_DCKCFGR2_SPDIFRXSEL)
/**
  * @}
  */
...
#define RCC_SAIACLKSOURCE_EXT                ((std::uint32_t)RCC_DCKCFGR_SAI1ASRC_0)
#define RCC_SAIACLKSOURCE_PLLR               ((std::uint32_t)RCC_DCKCFGR_SAI1ASRC_1)
#define RCC_SAIACLKSOURCE_PLLSRC             ((std::uint32_t)RCC_DCKCFGR_SAI1ASRC_0 | RCC_DCKCFGR_SAI1ASRC_1)
/**
  * @}
  */
...
#define RCC_SAIBCLKSOURCE_EXT                ((std::uint32_t)RCC_DCKCFGR_SAI1BSRC_0)
#define RCC_SAIBCLKSOURCE_PLLR               ((std::uint32_t)RCC_DCKCFGR_SAI1BSRC_1)
#define RCC_SAIBCLKSOURCE_PLLSRC             ((std::uint32_t)RCC_DCKCFGR_SAI1BSRC_0 | RCC_DCKCFGR_SAI1BSRC_1)
/**
  * @}
  */
...
#define RCC_LPTIM1CLKSOURCE_HSI             ((std::uint32_t)RCC_DCKCFGR2_LPTIM1SEL_0)
#define RCC_LPTIM1CLKSOURCE_LSI             ((std::uint32_t)RCC_DCKCFGR2_LPTIM1SEL_1)
#define RCC_LPTIM1CLKSOURCE_LSE             ((std::uint32_t)RCC_DCKCFGR2_LPTIM1SEL_0 | RCC_DCKCFGR2_LPTIM1SEL_1)
/**
  * @}
  */
...
#define RCC_DFSDM2AUDIOCLKSOURCE_I2S2       ((std::uint32_t)RCC_DCKCFGR_CKDFSDM2ASEL)
/**
  * @}
  */
...
#define RCC_DFSDM2CLKSOURCE_SYSCLK          ((std::uint32_t)RCC_DCKCFGR_CKDFSDM1SEL)
/**
  * @}
  */
...
#define RCC_PLLI2SCLKSOURCE_EXT             ((std::uint32_t)RCC_PLLI2SCFGR_PLLI2SSRC)
/**
  * @}
  */
...
#define RCC_DFSDM1AUDIOCLKSOURCE_I2S2       ((std::uint32_t)RCC_DCKCFGR_CKDFSDM1ASEL)
/**
  * @}
  */
...
#define RCC_DFSDM1CLKSOURCE_SYSCLK          ((std::uint32_t)RCC_DCKCFGR_CKDFSDM1SEL)
/**
  * @}
  */
...
/** @defgroup RCCEx_CLK48_Clock_Source  RCC CLK48 Clock Source
  ...
  */
#define RCC_CLK48CLKSOURCE_PLLQ             0x00000000U
#define RCC_CLK48CLKSOURCE_PLLI2SQ          ((std::uint32_t)RCC_DCKCFGR2_CK48MSEL)
/**
  * @}
  */
...
#define RCC_I2SAPBCLKSOURCE_EXT             ((std::uint32_t)RCC_DCKCFGR_I2SSRC_0)
#define RCC_I2SAPBCLKSOURCE_PLLSRC          ((std::uint32_t)RCC_DCKCFGR_I2SSRC_1)
/**
  * @}
  */
...
#define __HAL_RCC_BKPSRAM_CLK_ENABLE() do { \
                                            volatile std::uint32_t tmpreg = 0x00U; \
...
/** @brief Macros to enable or disable the PLLI2S.
  ...
  */
#define __HAL_RCC_PLLI2S_ENABLE() (*(volatile std::uint32_t *) RCC_CR_PLLI2SON_BB = ENABLE)
#define __HAL_RCC_PLLI2S_DISABLE() (*(volatile std::uint32_t *) RCC_CR_PLLI2SON_BB = DISABLE)
...
/** @brief Macros to Enable or Disable the PLLISAI.
  ...
  */
#define __HAL_RCC_PLLSAI_ENABLE() (*(volatile std::uint32_t *) RCC_CR_PLLSAION_BB = ENABLE)
#define __HAL_RCC_PLLSAI_DISABLE() (*(volatile std::uint32_t *) RCC_CR_PLLSAION_BB = DISABLE)
...
/** @brief  Macro to get the I2S clock source (I2SCLK).
  ...
  *                                        used as I2S clock source
  */
#define __HAL_RCC_GET_I2S_SOURCE() ((std::uint32_t)(READ_BIT(RCC->CFGR, RCC_CFGR_I2SSRC)))
...
/** @brief  Macro to configure the CEC clock.
  ...
  */
#define __HAL_RCC_CEC_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_CECSEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the FMPI2C1 clock.
  ...
  */
#define __HAL_RCC_FMPI2C1_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_FMPI2C1SEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the CLK48 clock.
  ...
  */
#define __HAL_RCC_CLK48_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_CK48MSEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the SDIO clock.
  ...
  */
#define __HAL_RCC_SDIO_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_SDIOSEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the SPDIFRX clock.
  ...
  */
#define __HAL_RCC_SPDIFRX_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_SPDIFRXSEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the CLK48 clock.
  ...
  *            @arg RCC_CLK48CLKSOURCE_PLLSAIP: PLLSAI VCO Output divided by PLLSAIP used as CLK48 clock.
  */
#define __HAL_RCC_CLK48_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_CK48MSEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the SDIO clock.
  ...
  *            @arg RCC_SDIOCLKSOURCE_SYSCLK: System clock output used as SDIO clock.
  */
#define __HAL_RCC_SDIO_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_SDIOSEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the DSI clock.
  ...
  */
#define __HAL_RCC_DSI_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR, RCC_DCKCFGR_DSISEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to get the DFSDM1 clock source.
  ...
  *            @arg RCC_DFSDM1CLKSOURCE_SYSCLK: System clock used as kernel clock.
  */
#define __HAL_RCC_GET_DFSDM1_SOURCE() ((std::uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1SEL)))
...
/** @brief  Macro to get the DFSDM2 clock source.
  ...
  *            @arg RCC_DFSDM2CLKSOURCE_SYSCLK: System clock used as kernel clock.
  */
#define __HAL_RCC_GET_DFSDM2_SOURCE() ((std::uint32_t)(READ_BIT(RCC->DCKCFGR, RCC_DCKCFGR_CKDFSDM1SEL)))
...
/** @brief  Macro to configure the LPTIM1 clock.
  ...
  */
#define __HAL_RCC_LPTIM1_CONFIG(__SOURCE__) (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_LPTIM1SEL, (std::uint32_t)(__SOURCE__)))
...
/** @brief  Macro to configure the PLL I2S clock source (PLLI2SCLK).
  ...
  *                                       used as I2S clock source.
  */
#define __HAL_RCC_PLL_I2S_CONFIG(__SOURCE__) (*(volatile std::uint32_t *) RCC_PLLI2SCFGR_PLLI2SSRC_BB = (__SOURCE__))
...
/** @brief  Macro to configure the Timers clocks prescalers
  ...
  */
#define __HAL_RCC_TIMCLKPRESCALER(__PRESC__) (*(volatile std::uint32_t *) RCC_DCKCFGR_TIMPRE_BB = (__PRESC__))
...
/** @brief  Macros to enable or disable the RCC MCO1 feature.
  */
#define __HAL_RCC_MCO1_ENABLE() (*(volatile std::uint32_t *) RCC_CFGR_MCO1EN_BB = ENABLE)
#define __HAL_RCC_MCO1_DISABLE() (*(volatile std::uint32_t *) RCC_CFGR_MCO1EN_BB = DISABLE)

/** @brief  Macros to enable or disable the RCC MCO2 feature.
  */
#define __HAL_RCC_MCO2_ENABLE() (*(volatile std::uint32_t *) RCC_CFGR_MCO2EN_BB = ENABLE)
#define __HAL_RCC_MCO2_DISABLE() (*(volatile std::uint32_t *) RCC_CFGR_MCO2EN_BB = DISABLE)
...
std::uint32_t HAL_RCCEx_GetPeriphCLKFreq(std::uint32_t PeriphClk);
