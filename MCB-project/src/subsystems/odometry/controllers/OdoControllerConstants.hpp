...
constexpr float C = 0.02;                                          // kg-s/m^2
constexpr float J = 0.0001;//259;                                        // kg-m^2
...
constexpr float KP = 25;                                            // 10.5;  // sec^-1
constexpr float THETA_DOT_BREAK = 99999;                              // rad/s
constexpr float A_DECEL = 0.2 * VOLT_MAX * KT * RATIO / (J * RA);  // experimental per Alex_Y

// Feedforward  constexprants
constexpr float A_SCALE = 0.5;  // 0.8            // unitless
...
// Velocity feedback
constexpr float KPV = 0.09;                       // A-s/rad
constexpr float KIV = 0.02;                      // A/rad
constexpr float IV_MAX = 0;              // units TBD
