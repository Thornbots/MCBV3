...
static constexpr float YAW_OUT_SHOOT_THRESH = PI / 3; //if cv wants to move the yaw less than this amount, allow shooting
...
static constexpr float PITCH_MULTIPLY_SCALE = 0.00000005f;
