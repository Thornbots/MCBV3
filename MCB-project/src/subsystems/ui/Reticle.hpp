...
public:  // important constants and enums
    // panel things
    static constexpr float PANEL_WIDTH = 0.135;               // meters, hero is 0.230
    ...
    static constexpr float DISTANCES[NUM_THINGS] = {0.5, 1, 2, 5, 9, 12};  // meters, y distances, measured from center of robot to center of panel
