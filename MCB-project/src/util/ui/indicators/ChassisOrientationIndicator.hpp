...
private:
    ...
    Arc left{RefSerialData::Tx::GraphicColor::RED_AND_BLUE, UIScheduler::HALF_SCREEN_WIDTH, UIScheduler::HALF_SCREEN_HEIGHT, INNER_SIZE, INNER_SIZE, 0, INNER_ARC_LEN, THICKNESS};
    Arc right{RefSerialData::Tx::GraphicColor::RED_AND_BLUE, UIScheduler::HALF_SCREEN_WIDTH, UIScheduler::HALF_SCREEN_HEIGHT, INNER_SIZE, INNER_SIZE, 0, INNER_ARC_LEN, THICKNESS};
};