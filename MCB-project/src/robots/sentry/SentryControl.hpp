...
public:
    ...
    commands::SimpleAutoDriveCommand simpleAutoDrive{drivers, &drivetrain, &gimbal, commands::SimpleAutoDriveCommand::TargetMode::ARCC_RAMP_PATH_HYPOTENUSE_ADJUSTED};
