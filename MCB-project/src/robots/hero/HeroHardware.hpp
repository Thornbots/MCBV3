...
public:
    ...
    //motors 
    DjiMotor flywheelMotor1{drivers, MotorId::MOTOR7, CanBus::CAN_BUS2, false, "Flywheel"};
    DjiMotor flywheelMotor2{drivers, MotorId::MOTOR8, CanBus::CAN_BUS2, true, "Flywheel"};
